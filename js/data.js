...
// ---------- Student Documents ----------
/**
 * Add a document to a student's record.
 * Uploads file to Firebase Storage and stores metadata in the student's document list.
...
/**
 * Remove a document from a student's record and delete the file from Storage.
 * @param {string} studentId - Student ID
 ...
 * Deletes the old photo from Storage before uploading the new one.
 * @param {string} studentId - Student ID
